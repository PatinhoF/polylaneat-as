...
if __name__ == "__main__":
    ...
    logging.info(
        "Train dataset ready: {} images, max_lanes={}, max_points={}".format(
            len(train_dataset),
            getattr(train_dataset.dataset, "max_lanes", "n/a"),
            getattr(train_dataset.dataset, "max_points", "n/a"),
        )
    )
    ...
    if args.validate:
        ...
        logging.info(
            "Val dataset ready: {} images, max_lanes={}, max_points={}".format(
                len(val_dataset),
                getattr(val_dataset.dataset, "max_lanes", "n/a"),
                getattr(val_dataset.dataset, "max_points", "n/a"),
            )
        )
    ...
    logging.info(
        "Test dataset ready: {} images, max_lanes={}, max_points={}".format(
            len(test_dataset),
            getattr(test_dataset.dataset, "max_lanes", "n/a"),
            getattr(test_dataset.dataset, "max_points", "n/a"),
        )
    )
